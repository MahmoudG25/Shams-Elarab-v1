...
import { getProduct, saveOrder, calculateOrderTotals } from '../../utils/checkoutUtils';
...
const PaymentSubmission = () => {
  ...
  useEffect(() => {
    if (productId && productType) {
      const fetchedProduct = getProduct(productId, productType);
      if (fetchedProduct) {
  ...
  const handleSubmit = () => {
    ...
    const orderData = {
      ...
      receiptFile: file ? file.name : null
    };
    ...
    setTimeout(() => {
      ...
      navigate('/checkout/review', { state: { order: orderData } });
    }, 1500);
  };
